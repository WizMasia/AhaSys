    ...
    <div className="space-y-6">
      ...
      <div className={`p-6 rounded-3xl border ${darkMode ? 'bg-[#0f1524] border-slate-800' : 'bg-white border-slate-200 shadow-sm'}`}>
        ...
        <div className="text-sm text-slate-300 leading-relaxed space-y-4">
          <p>
            <strong>아하시스턴트 (aHaSys)</strong>는 제출된 마케팅 안 및 카드뉴스 이미지 초안을 정밀 검증하여 공정위 과장 기만 금지 규정, 개별 도메인 특별법, 지식재산권 공시 가이드라인, 그리고 역사적 참사/사회적 비극 상업 오용 금지 기준 위배 여부를 RAG 기반으로 사전 통제하는 준법 심의 지원 시스템입니다.
          </p>
          <p>
            검수 시 텍스트 문안 혹은 상세페이지/카드뉴스 이미지 파일에 대해 실시간 멀티모달 Vision AI 및 지능형 5대 도메인 에이전트 라우팅 엔진이 작동하여 법률 리스크와 시각 자료 왜곡 요소를 다각적으로 진단합니다.
          </p>
        </div>
      </div>
